...
// Integrations
const integrations = [
  { name: 'WhatsApp', color: '#25D366', description: 'Customer messaging' },
  { name: 'Slack', color: '#4A154B', description: 'Team notifications' },
  { name: 'Google Sheets', color: '#0F9D58', description: 'Data sync' },
  { name: 'Zoom', color: '#2D8CFF', description: 'Video meetings' },
  { name: 'Tally', color: '#ED1C24', description: 'Accounting' },
  { name: 'Zapier', color: '#FF4A00', description: '5000+ apps' },
  { name: 'Google Calendar', color: '#4285F4', description: 'Scheduling' },
  { name: 'Pabbly', color: '#5468FF', description: 'Automation' }
]
...
export default function EnterpriseLanding({ onLogin }) {
  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      {/* ==================== INTEGRATIONS ==================== */}
      <section id="integrations" className="py-16 lg:py-24 bg-slate-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 lg:gap-6">
            {integrations.map((integration, i) => (
              <motion.div
                ...
                className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-5 lg:p-6 text-center hover:bg-white/10 transition-all group"
              >
                <div 
                  className="w-14 h-14 mx-auto rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform"
