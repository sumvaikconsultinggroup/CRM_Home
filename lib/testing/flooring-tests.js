  ...
  products: {
    ...
    tests: [
      ...
      },
      {
        ...
        method: 'GET',
        endpoint: '/api/flooring/enhanced/products?search=Oak',
        expectedStatus: 200,
        validate: (response) => response.products !== undefined
      }
    ]
  },
  ...
  inventory: {
    ...
    tests: [
      ...
      },
      {
        ...
        method: 'GET',
        endpoint: '/api/modules/wooden-flooring/inventory/movements',
        expectedStatus: 200,
        validate: (response) => response.movements !== undefined
      },
      {
        name: 'Get Low Stock Alerts',
        method: 'GET',
        endpoint: '/api/modules/wooden-flooring/inventory/alerts',
        expectedStatus: 200,
        validate: (response) => response.alerts !== undefined || Array.isArray(response)
      }
    ]
  },
  ...
  rbac: {
    ...
    tests: [
      ...
      },
      {
        name: 'Get Audit Log',
        method: 'GET',
        endpoint: '/api/flooring/enhanced/access-management?action=audit_log',
        expectedStatus: 200,
        validate: (response) => response.logs !== undefined
      }
    ]
  },
  ...
  system: {
    ...
    tests: [
      ...
      },
      {
        name: 'Index Stats',
        method: 'GET',
        endpoint: '/api/flooring/enhanced/system?action=indexes',
        expectedStatus: 200,
        validate: (response) => response.indexes !== undefined
      }
    ]
  },
    ...
    tests: [
      {
        name: 'Get Invoices',
        method: 'GET',
        endpoint: '/api/flooring/enhanced/invoices',
        expectedStatus: 200,
        validate: (response) => response.invoices !== undefined
      }
    ]
  },
    ...
    tests: [
      {
        name: 'Get Quotes',
        method: 'GET',
        endpoint: '/api/flooring/enhanced/quotes',
        expectedStatus: 200,
        validate: (response) => response.quotes !== undefined || Array.isArray(response)
      }
    ]
  },

  /**
   * Test 10: Installations
   */
  installations: {
    name: 'Installations',
    tests: [
      {
        ...
        method: 'GET',
        endpoint: '/api/flooring/enhanced/installations',
        expectedStatus: 200,
        validate: (response) => response.installations !== undefined || Array.isArray(response)
      },
      {
        name: 'Get Installers',
        method: 'GET',
        endpoint: '/api/flooring/enhanced/installers',
        expectedStatus: 200,
        validate: (response) => response.installers !== undefined || Array.isArray(response)
      }
    ]
  },
    ...
    tests: [
      {
        ...
        method: 'GET',
        endpoint: '/api/flooring/enhanced/reports?type=summary',
        expectedStatus: 200,
