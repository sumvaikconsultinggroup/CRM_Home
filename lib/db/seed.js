...
export const industryModules = [
  { id: uuidv4(), name: 'Wooden Flooring', description: 'Project management for flooring installation, sales pipeline, order tracking, invoicing', price: 999, icon: 'Layers', category: 'flooring', active: true, features: ['Project Tracking', 'Order Management', 'Invoicing', 'Material Calculator'] },
  { id: uuidv4(), name: 'Kitchens', description: 'Sales pipeline, supplier management, design approval workflow, project tracking', price: 999, icon: 'ChefHat', category: 'kitchen', active: true, features: ['Design Workflow', 'Supplier Portal', '3D Visualization', 'Quote Generator'] },
  { id: uuidv4(), name: 'Tiles', description: 'Client inquiries, quotes, order management, delivery scheduling', price: 999, icon: 'Grid3X3', category: 'tiles', active: true, features: ['Quote Builder', 'Delivery Tracking', 'Inventory Sync', 'Pattern Matcher'] },
  { id: uuidv4(), name: 'Furniture', description: 'Custom furniture orders, design management, production tracking', price: 999, icon: 'Sofa', category: 'furniture', active: true, features: ['Custom Orders', 'Design Gallery', 'Production Timeline', 'Delivery Management'] },
  { id: uuidv4(), name: 'Contractors', description: 'Contractor management, scheduling, payments, compliance tracking', price: 999, icon: 'HardHat', category: 'contractors', active: true, features: ['Contractor Portal', 'Schedule Management', 'Payment Tracking', 'Compliance Docs'] },
  { id: uuidv4(), name: 'Painting', description: 'Color consultation, project estimates, material tracking', price: 999, icon: 'Paintbrush', category: 'painting', active: true, features: ['Color Visualizer', 'Estimate Builder', 'Material Calculator', 'Before/After Gallery'] },
  { id: uuidv4(), name: 'Plumbing', description: 'Service requests, inventory management, technician scheduling', price: 999, icon: 'Wrench', category: 'plumbing', active: true, features: ['Service Tickets', 'Technician App', 'Parts Inventory', 'Route Optimization'] },
  { id: uuidv4(), name: 'Electrical', description: 'Electrical projects, safety compliance, equipment tracking', price: 999, icon: 'Zap', category: 'electrical', active: true, features: ['Safety Checklists', 'Permit Tracking', 'Equipment Management', 'Compliance Reports'] }
]
  ...
  try {
    ...
    if (!adminExists) {
      await usersCollection.insertOne({
        ...
        password: Buffer.from('admin123' + 'salt_key_2024').toString('base64'),
        name: 'Super Admin',
        role: 'super_admin',
        clientId: null,
        createdAt: new Date(),
